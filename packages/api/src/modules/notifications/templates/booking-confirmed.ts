...
export function bookingConfirmedTemplate(data: BookingNotificationData): {
  subject: string;
  html: string;
  text: string;
} {
  ...
  const subject = `Booking Confirmed — ${data.bookingReference} | AirportFaster`;
...
<body style="margin:0;padding:0;background-color:#0a0e1a;font-family:Arial,sans-serif;">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#111827;border-radius:12px;overflow:hidden;border:1px solid rgba(255,255,255,0.05);">
          ...
          <tr>
            <td style="padding:32px;">
              <h2 style="color:#c9a84c;margin:0 0 8px;">Booking Confirmed!</h2>
              <p style="color:#d1d5db;margin:0 0 24px;">Hi ${data.customerFirstName}, your booking has been confirmed. Here are your details:</p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid rgba(255,255,255,0.05);border-radius:8px;overflow:hidden;margin-bottom:24px;">
                <tr style="background-color:rgba(201,168,76,0.1);">
                  <td colspan="2" style="padding:12px 16px;color:#c9a84c;font-weight:bold;font-size:12px;text-transform:uppercase;letter-spacing:0.05em;">Booking Details</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="padding:12px 16px;color:#9ca3af;font-size:14px;border-top:1px solid rgba(255,255,255,0.05);">Total</td>
                  <td style="padding:12px 16px;color:#c9a84c;font-size:14px;font-weight:bold;border-top:1px solid rgba(255,255,255,0.05);">${data.currency} ${formattedAmount}</td>
                </tr>
              </table>

              <p style="color:#9ca3af;font-size:13px;margin:0;">Need help? Contact us at <a href="mailto:support@airportfaster.com" style="color:#c9a84c;">support@airportfaster.com</a></p>
            </td>
          </tr>
          <!-- Footer -->
          <tr>
  ...
  const text = `
Booking Confirmed — AirportFaster
...
Date: ${formattedDate}
Total: ${data.currency} ${formattedAmount}

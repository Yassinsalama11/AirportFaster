...
export function bookingAssignedTemplate(data: BookingNotificationData): {
  subject: string;
  html: string;
  text: string;
} {
  ...
  const subject = `New Booking Assignment — ${data.bookingReference} | AirportFaster`;
...
<body style="margin:0;padding:0;background-color:#0a0e1a;font-family:Arial,sans-serif;">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#111827;border-radius:12px;overflow:hidden;border:1px solid rgba(255,255,255,0.05);">
          ...
          <tr>
            <td style="background-color:#c9a84c;padding:24px 32px;">
              ...
              <p style="margin:4px 0 0;color:#0a0e1a;font-size:14px;opacity:0.8;">Supplier Portal</p>
            </td>
          </tr>
          <!-- Body -->
          <tr>
            <td style="padding:32px;">
              <h2 style="color:#c9a84c;margin:0 0 8px;">New Booking Assignment</h2>
              <p style="color:#d1d5db;margin:0 0 24px;">A new booking has been assigned to ${data.supplierName ?? 'your company'}. Please review the details below and prepare for the service.</p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid rgba(255,255,255,0.05);border-radius:8px;overflow:hidden;margin-bottom:24px;">
                <tr style="background-color:rgba(201,168,76,0.1);">
                  <td colspan="2" style="padding:12px 16px;color:#c9a84c;font-weight:bold;font-size:12px;text-transform:uppercase;letter-spacing:0.05em;">Assignment Details</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="padding:12px 16px;color:#9ca3af;font-size:14px;border-top:1px solid rgba(255,255,255,0.05);">Customer</td>
                  <td style="padding:12px 16px;color:#f9fafb;font-size:14px;border-top:1px solid rgba(255,255,255,0.05);">${data.customerFirstName} ${data.customerLastName}</td>
                </tr>
              </table>

              <p style="color:#d1d5db;margin:0 0 16px;font-size:14px;">Please confirm this assignment through your supplier portal or reply to this email.</p>
              <p style="color:#9ca3af;font-size:13px;margin:0;">Questions? Contact <a href="mailto:operations@airportfaster.com" style="color:#c9a84c;">operations@airportfaster.com</a></p>
            </td>
          </tr>
          <!-- Footer -->
          <tr>
  ...
  const text = `
New Booking Assignment — AirportFaster Supplier Portal

A new booking has been assigned to ${data.supplierName ?? 'your company'}.
...
Please confirm this assignment through your supplier portal or contact operations@airportfaster.com

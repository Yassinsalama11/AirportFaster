...
import { AvailabilityRuleForm } from '@/components/admin/availability/AvailabilityRuleForm';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <span className="text-gray-600">/</span>
        <Link
          href={`/admin/airports/${id}/availability`}
          className="text-gray-400 hover:text-brand-white text-sm transition-colors"
        >
          Availability
        </Link>
      ...
      <div className="bg-brand-navy border border-white/5 rounded-xl p-6">
        <AvailabilityRuleForm airportId={id} airportServices={airport.airportServices} />
      </div>
    </div>
  );
}
